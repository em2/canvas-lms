...
class Account < ActiveRecord::Base
  ...
  def tabs_available(user=nil, opts={})
    ...
    if site_admin?
      ...
      tabs << { :id => TAB_QUESTION_BANKS, :label => t('#account.tab_question_banks', "Question Banks"), :css_class => 'question_banks', :href => :account_question_banks_path } if user && self.grants_right?(user, nil, :manage_grades) && user.account.site_admin?
