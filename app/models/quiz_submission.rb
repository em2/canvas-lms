...
class QuizSubmission < ActiveRecord::Base
  ...
  def self.score_question(q, params)
    ...
    result[:explain_area] = params["explain_area_#{q[:id]}"] rescue ""
    result[:explain_canvas_click_x_data] = params["explain_canvas_#{q[:id]}_click_x_data"] rescue ""
    result[:explain_canvas_click_y_data] = params["explain_canvas_#{q[:id]}_click_y_data"] rescue ""
    result[:explain_canvas_click_color_data] = params["explain_canvas_#{q[:id]}_click_color_data"] rescue ""
    result[:explain_canvas_click_tool_data] = params["explain_canvas_#{q[:id]}_click_tool_data"] rescue ""
    result[:explain_canvas_click_size_data] = params["explain_canvas_#{q[:id]}_click_size_data"] rescue ""
    result[:explain_canvas_click_drag_data] = params["explain_canvas_#{q[:id]}_click_drag_data"] rescue ""
