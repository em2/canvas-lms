class ClassReport < ActiveRecord::Base
	...
	def calculate_reports()
		...
		self.q = data["q"]
		self.number_correct = data["number_correct"]
		self.number_attempted = data["number_attempted"]
		self.percent_correct = data["percent_correct"]
		self.item_analysis = data["item_analysis"]
		...
		self.submitted_student_count = data["submitted_students_count"]
    ...
    # data["submissions"] = submissions.to_json
