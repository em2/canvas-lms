ActionController::Routing::Routes.draw do |map|
  ...
  map.rosters  '/rosters', :controller => 'rosters', :action => 'show'
  map.select_school  '/select_school_roster_to_show', :controller => 'rosters', :action => 'select_school_roster_to_show'
