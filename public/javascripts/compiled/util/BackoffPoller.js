  ...
  define(['jquery', 'jquery.ajaxJSON'], function(jQuery) {
    ...
    return BackoffPoller = (function() {
      function BackoffPoller(url, handler, opts) {
        ...
        this.handleErrors = (_ref4 = opts.handleErrors) != null ? _ref4 : false;
        this.initialDelay = (_ref5 = opts.initialDelay) != null ? _ref5 : true;
      }
      ...
      BackoffPoller.prototype.poll = function() {
        this.running = true;
        this.attempts++;
        return jQuery.ajaxJSON(this.url, 'GET', {}, this.handle, __bind(function(data, xhr) {
          if (this.handleErrors) {
            return this.handle(data, xhr);
          } else {
            return this.stop();
          }
        }, this));
