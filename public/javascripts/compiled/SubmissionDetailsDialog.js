(function() {
  ...
  define(['jquery', 'jst/SubmissionDetailsDialog', 'jst/_submission_detail', 'jquery.ajaxJSON', 'jquery.disableWhileLoading', 'jquery.instructure_forms', 'jquery.instructure_jquery_patches', 'jquery.instructure_misc_plugins', 'vendor/jquery.scrollTo'], function($, submissionDetailsDialog) {
