(function() {
  ...
  define(['i18n!gradebook2', 'jquery', 'jst/CurveGradesDialog', 'jquery.disableWhileLoading', 'jquery.instructure_forms', 'jquery.instructure_jquery_patches', 'jquery.instructure_misc_plugins', 'compiled/jquery/fixDialogButtons', 'vendor/jquery.ba-tinypubsub'], function(I18n, $, curveGradesDialogTemplate) {
