(function() {
  ...
  define(['i18n!gradebook2', 'jquery', 'message_students', 'compiled/AssignmentDetailsDialog', 'compiled/AssignmentMuter', 'compiled/gradebook2/SetDefaultGradeDialog', 'compiled/gradebook2/CurveGradesDialog', 'jst/gradebook2/GradebookHeaderMenu', 'jst/re_upload_submissions_form', 'use!underscore', 'jquery.instructure_forms', 'jquery.instructure_jquery_patches', 'jquery.instructure_misc_helpers', 'jquery.instructure_misc_plugins', 'compiled/jquery.kylemenu'], function(I18n, $, messageStudents, AssignmentDetailsDialog, AssignmentMuter, SetDefaultGradeDialog, CurveGradesDialog, gradebookHeaderMenuTemplate, re_upload_submissions_form, _) {
