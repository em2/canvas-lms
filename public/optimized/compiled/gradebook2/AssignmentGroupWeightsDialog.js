(function() {
  ...
  define(['jquery', 'jst/AssignmentGroupWeightsDialog', 'jquery.ajaxJSON', 'jquery.disableWhileLoading', 'jquery.instructure_jquery_patches', 'jquery.instructure_misc_helpers', 'vendor/jquery.ba-tinypubsub'], function($, assignmentGroupWeightsDialogTemplate) {
    ...
    return AssignmentGroupWeightsDialog = (function() {
      function AssignmentGroupWeightsDialog(options) {
        ...
        this.render = __bind(this.render, this);        this.$dialog = $(assignmentGroupWeightsDialogTemplate());
        this.$dialog.dialog({
          autoOpen: false,
          resizable: false,
          width: 350,
