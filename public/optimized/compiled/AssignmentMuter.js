(function() {
  ...
  define(['i18n!assignment_muter', 'jquery', 'jst/mute_dialog', 'jquery.ajaxJSON', 'jquery.disableWhileLoading', 'jquery.instructure_jquery_patches', 'vendor/jquery.ba-tinypubsub'], function(I18n, $, mute_dialog_template) {
    var AssignmentMuter;
